...
float4 main(INPUT_PIXEL input) : SV_TARGET
{
	...
	float4 PointLightColor_01 = {0.5f, 0.5f, 0.5f, 1.0f};
	float4 PointLightColor_02 = {0.5f, 0.5f, 0.5f, 1.0f};
	float4 PointLightColor_03 = {0.5f, 0.5f, 0.5f, 1.0f};
	float4 PointLightColor_04 = {0.5f, 0.5f, 0.5f, 1.0f};
	...
	finalColor = float4(averageColor, averageColor, averageColor + 0.1f, finalColor.w);
